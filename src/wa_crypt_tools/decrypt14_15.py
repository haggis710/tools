...
from wa_crypt_tools.lib.common_utils import SimpleLog
from wa_crypt_tools.lib.key import Key
from wa_crypt_tools.lib.common_utils import oscillate, test_decompression

from wa_crypt_tools.lib.common_utils import import_aes
AES = import_aes()
...
from wa_crypt_tools.lib.constants import DEFAULT_IV_OFFSET, DEFAULT_DATA_OFFSET, HEADER_SIZE, ZLIB_HEADERS
import argparse
import zlib
